...
[![Dependencies](https://img.shields.io/github/actions/workflow/status/scottbass3/beacon/dependencies.yml?branch=main&event=push&label=dependencies)](https://github.com/scottbass3/beacon/actions/workflows/dependencies.yml)
